...
**Follow-up:** Manual end-to-end smoke with real Trello credentials; optional courses-load retry/decouple; dashboard refetch for `trelloSyncedTasks` when dashboard metrics exist (future).
