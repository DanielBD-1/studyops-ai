...
**Not implemented (intentional):** Dashboard frontend UI consuming stats; admin dashboard; **`/dashboard`** stub remains unchanged
**Follow-up:** Dashboard frontend UI phase consuming **`GET /api/dashboard/stats`**
