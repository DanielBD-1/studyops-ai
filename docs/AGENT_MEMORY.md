...
**Current-state correction (DOCS-CONSISTENCY-FIX, 2026-06-04) — do not reopen A5B/A5C:**
...
- **A5A, A5B, and A5C are implemented** — not deferred. Older journal entries that say “OAuth not live”, “manual-only sync path”, or “A5B not started” are **historical** (pre-ship or docs-only gates).
