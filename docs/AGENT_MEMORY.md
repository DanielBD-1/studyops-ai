...
**Tests:** none (docs-only)
**Pitfalls:** Do not document frontend stored-token sync as live; do not claim **`/trello`** omits manual credentials until **A5B**; backend A5A ≠ user-facing connected sync UX; manual override while connected is intentional A5A compatibility — wrong-account risk deferred to **A5C**
