...
- **B4-F3C3 completion does not automatically approve** **B4-F3B**, sidebar, chart UI/APIs, or backend/API extension — those are separate gated phases.
