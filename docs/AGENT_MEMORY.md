...
**Pitfalls:** Do not claim cross-course unlinked filter when **All courses** selected on global **`/tasks`**. Do not claim **`/courses/:id`** URL-persisted material filters. Do not claim dashboard material counts. Do not claim migration **015** changed.
