...
| **B1 deep link** | **`buildTasksPageMaterialLink(courseId, materialId)`** unchanged — **`MaterialRelatedTasksSection`** **View linked tasks** link contract preserved |
...
| **B1 deep link** | **`buildTasksPageMaterialLink(courseId, materialId)`** unchanged — UUID material deep links only |
