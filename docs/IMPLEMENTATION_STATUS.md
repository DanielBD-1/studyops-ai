...
**Not in B3 (historical):** Charts; gamification; BX-I1 dark/glass; **B4** global rollout was **not started at B3** (**B4** partial as of **2026-06-02** — see **B4-F3C** / **B4-F3B** status in **`CURRENT_STATE.md`**).
...
**Not in B4-F1:** **`LoadingState.jsx`**, **`EmptyState.jsx`**, **`ErrorMessage.jsx`**, **`layout.css`**, **`tokens.css`**, page/route/service/API/auth/data-fetching/error-mapping changes; **B4-F2** route state framing (now complete — commit **`ee50b8e`**); **B4-F3A** secondary in-page state surfaces (now complete — commit **`596e869`**); **B4-F3C** sub-series (now complete — **`d0393d7`**, **`d1a3c69`**, **`ab28307`**); **B4-F3B** — requires separate planning and explicit approval.
...
**Not in B4-F2:** **B4-F3A** secondary in-page state surfaces (now complete — commit **`596e869`**); **B4-F3C** sub-series (now complete); **B4-F3B** — requires separate planning and explicit approval.
...
| **Not fixed** | **TrelloTaskSelector** EmptyState invalid **`message`** prop — intentionally deferred |
| **Deferred at B4-F3A (historical)** | **B4-F3B** wrapper **`className`** work; **B4-F3C** AI/a11y/bug-fix work (**B4-F3C** sub-series now **complete** — commits **`d0393d7`**, **`d1a3c69`**, **`ab28307`**; **B4-F3B** still **not started**) |
...
**Not in B4-F3A:** **B4-F3B** wrapper **`className`** work; **B4-F3C** AI/a11y/bug-fix work (**B4-F3C** sub-series now **complete** separately — **B4-F3B** still requires separate planning and explicit approval).
