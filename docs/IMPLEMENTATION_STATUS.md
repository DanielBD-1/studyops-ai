...
**Not in B4-F1:** **`LoadingState.jsx`**, **`EmptyState.jsx`**, **`ErrorMessage.jsx`**, **`layout.css`**, **`tokens.css`**, page/route/service/API/auth/data-fetching/error-mapping changes; **B4-F2** route state framing (now complete — commit **`ee50b8e`**); **B4-F3A** secondary in-page state surfaces (now complete — commit **`596e869`**); **B4-F3B**/**B4-F3C** — each requires separate planning and explicit approval.
...
**Not in B4-F2:** **B4-F3A** secondary in-page state surfaces (now complete — commit **`596e869`**); **B4-F3B**/**B4-F3C** — requires separate planning and explicit approval.
...
| **Not fixed** | **TrelloTaskSelector** EmptyState invalid **`message`** prop — intentionally deferred |
| **Not started** | **B4-F3B** wrapper **`className`** work; **B4-F3C** AI/a11y/bug-fix work |
...
**Not in B4-F3A:** **B4-F3B** wrapper **`className`** work; **B4-F3C** AI/a11y/bug-fix work — each requires separate planning and explicit approval.
...
| **Not started** | **B4-F3B** wrapper **`className`** work (**B4-F3C3** **GeneratedPlanHistory** preview cleanup **complete** — commit **`ab28307`**; **B4-F3C** sub-series **complete**) |
...
**Not in B4-F3C1:** **B4-F3B** wrapper **`className`** work; **B4-F3C2** AI lane **`aria-live`** cleanup (**complete** — commit **`d1a3c69`**); **B4-F3C3** **GeneratedPlanHistory** preview review/fix (**complete** — commit **`ab28307`**) — **B4-F3C** sub-series **complete**; remaining phases require separate planning and explicit approval.
...
| **Not started** | **B4-F3B** wrapper **`className`** work (**B4-F3C3** **GeneratedPlanHistory** preview cleanup **complete** — commit **`ab28307`**) |
...
**Not in B4-F3C2:** **B4-F3B** wrapper **`className`** work; **B4-F3C3** **GeneratedPlanHistory** preview review/fix (**complete** — commit **`ab28307`**) — each remaining phase requires separate planning and explicit approval.
...
| **Not started** | **B4-F3B** wrapper **`className`** work — **B4-F3C** sub-series (**B4-F3C1**, **B4-F3C2**, **B4-F3C3**) **complete** |
...
**Not in B4-F3C3:** **B4-F3B** wrapper **`className`** work — requires separate planning and explicit approval. **B4-F3C** sub-series is **complete**; next implementation phase is **not automatic**.

**Implementation files:** `frontend/src/components/materials/GeneratedPlanHistorySection.jsx`.

---

## Implemented — UI presentation polish (Phases 8A–8C, 12A-1, B1–B3, BX-I2, BX-I3, BX-I4, BX-I5, BX-I6B, BX-I6C, BX-I6D, B4-A, B4-B, B4-C, B4-D, B4-E, B4-F1, B4-F2, B4-F3A, B4-F3C1, B4-F3C2, B4-F3C3)
