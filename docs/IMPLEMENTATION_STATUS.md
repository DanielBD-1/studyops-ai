...
**Likely follow-ups (not automatic):** **BX-I8D** Motion micro-pass; **BX-I8E** Global controls / card shape alignment — each requires separate planning + explicit approval.
