...
| **Not started** | **B4-F3B** wrapper **`className`** work; **B4-F3C3** **GeneratedPlanHistory** preview **`aria-live`** / error semantics review/fix (**B4-F3C2** AI lane cleanup **complete** — commit **`d1a3c69`**) |
...
**Not in B4-F3C1:** **B4-F3B** wrapper **`className`** work; **B4-F3C2** AI lane **`aria-live`** cleanup (**complete** — commit **`d1a3c69`**); **B4-F3C3** **GeneratedPlanHistory** preview review/fix — each requires separate planning and explicit approval.
...
| **Not started** | **B4-F3B** wrapper **`className`** work; **B4-F3C3** **GeneratedPlanHistory** preview **`aria-live`** / error semantics review/fix |
...
**Not in B4-F3C2:** **B4-F3B** wrapper **`className`** work; **B4-F3C3** **GeneratedPlanHistory** preview review/fix — each requires separate planning and explicit approval.

**Implementation files:** `frontend/src/pages/StudyMaterialDetail.jsx`.

---

## Implemented — UI presentation polish (Phases 8A–8C, 12A-1, B1–B3, BX-I2, BX-I3, BX-I4, BX-I5, BX-I6B, BX-I6C, BX-I6D, B4-A, B4-B, B4-C, B4-D, B4-E, B4-F1, B4-F2, B4-F3A, B4-F3C1, B4-F3C2)
