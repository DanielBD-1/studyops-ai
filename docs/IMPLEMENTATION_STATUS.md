...
**Polish only:** Improves flashcard study presentation — does **not** complete full Stitch-level UI or implement AI Generate gradient.

**Likely follow-ups (not automatic):** **BX-I10A2** Material-only AI Generate gradient; glass/elevation pass; optional plan-variant flashcard smoke after plan generate — each requires separate planning + explicit approval.
