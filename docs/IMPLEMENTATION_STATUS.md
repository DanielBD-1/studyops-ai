...
## Implemented — UI presentation polish (Phases 8A–8C, 12A-1, B1–B3, BX-I2, BX-I3, BX-I4, BX-I5, BX-I6B, BX-I6C, BX-I6D)
...
**UI polish status:** **Complete** through **BX-I6D** (after **B3**). **Phase B4** global styling rollout and remaining **BX-I6** work (sidebar, chart UI, chart APIs, tasks/flashcards/Trello/admin page body polish, backend/API extension **in code**) are **not started** — **not automatic** after BX-I6D; each requires separate planning and explicit human approval after Supervisor Review. **BX-I1** codified Stitch direction in **`DESIGN.md` v2.3**; **BX-I2** shipped the token foundation in **`tokens.css`**; **BX-I3** shipped the dashboard decision layout; **BX-I4** wired deterministic course accents; **BX-I5** polished the material detail cockpit; **BX-I6B** upgraded **`/dashboard`** presentation; **BX-I6C** aligned **`/courses`** and **`/courses/:id`** presentation; **BX-I6D** polished global **`AppShell`** chrome. Design screenshots under `docs/design/screenshots/` may predate **8C** / **12A-1** / **B1–B3** / **BX-I2** / **BX-I3** / **BX-I4** / **BX-I5** / **BX-I6B** / **BX-I6C** / **BX-I6D** visuals.
...
- **Phase B4** global visual system rollout — **not started** (requires explicit `approved — implement Phase B4` after Supervisor Review). **Phases 8A–8C**, **12A-1**, **B1**–**B3**, **BX-I2**, **BX-I3**, **BX-I4**, **BX-I5**, **BX-I6B**, **BX-I6C**, and **BX-I6D** are **complete** — dark graphite / glass token foundation in **`tokens.css`**; rule-based dashboard decision layout + command-center presentation in **`DashboardStub.jsx`** (**BX-I3** + **BX-I6B**); deterministic course accents on list/detail/dashboard (**BX-I4**); material detail cockpit visual polish (**BX-I5**); courses / course-detail visual alignment (**BX-I6C**); global **`AppShell`** shell chrome (**BX-I6D**, **`layout.css`** only); remaining **BX-I6** work (sidebar, chart UI, chart APIs, tasks/flashcards/Trello/admin page body polish, backend/API extension **in code**) is **not started** — requires separate planning and explicit approval each
- Further **UI styling** beyond **BX-I6D** (charts, sidebar, course accents on material detail, **B4**, tasks/flashcards/Trello/admin page body polish) requires explicit human approval — **`DESIGN.md` v2.3** direction for those surfaces is **not built** until a gated **BX-I6**, or **B4** phase; **`11-generated-plan-visible.png`** **captured** (Phase 2K-c); **`15-processing-with-ai.png`** still **pending** (see `docs/design/SCREENSHOT_INDEX.md`; committed PNGs may predate **8C** / **12A-1** / **B1–B3** / **BX-I2** / **BX-I3** / **BX-I4** / **BX-I5** / **BX-I6B** / **BX-I6C** / **BX-I6D** — **`03-dashboard.png`** is a **pre-5C/pre-8C/pre-BX-I3/pre-BX-I4/pre-BX-I6B** reference)
