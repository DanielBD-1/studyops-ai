...
**Last updated:** 2026-06-02 (Phase **BX-I6C** — courses visual alignment documentation housekeeping; prior **BX-I6B**)
...
**Not live:** chart UI, sidebar shell, course accents on material detail, AppShell/global motion rollout, or **BX-I6D** / **B4** — require separate planning and explicit approval.

**Branch (as of BX-I6C docs):** post-**BX-I6C** (commit **`6a1e6ad`**)
...
| **BX-I6D** | **Not started** | AppShell/global motion and broader visual rollout — **not automatic** after BX-I6C; requires separate planning and explicit approval. |
| **B4** | **Not started** | Global styling rollout beyond BX-I2 token foundation — requires explicit **`approved — implement Phase B4`**. |
| **BX-I6** (umbrella) | **Partial** | **BX-I6B** dashboard presentation and **BX-I6C** courses/course-detail presentation **complete**; sidebar shell, chart UI, chart APIs, AppShell/global motion (**BX-I6D**), and backend/API extension **not started** — separate gates each. |
...
- **BX-I6D** — AppShell/global motion, broader visual rollout (requires separate planning and explicit approval)
...
| **BX-I6D / B4** | **Not started** — **not automatic** after BX-I6C; each requires separate planning and explicit **`approved — implement Phase X`** |

**Human next step (typical):** Optional authenticated visual QA for **BX-I2**, **BX-I3**, **BX-I4**, and **BX-I5** when a valid local test account exists → plan **BX-I6D**, remaining **BX-I6** work (sidebar, chart UI/APIs), or **B4** separately with explicit implement approval. **Do not** start AppShell/global motion, chart libraries, sidebar shell, dashboard changes, or backend/API extension without a separately approved phase. Next implementation phase is **not automatic**.
...
| B4 or BX-I6D already approved | **Not started** — **BX-I6B** dashboard and **BX-I6C** courses/course-detail presentation are complete; AppShell/global motion (**BX-I6D**), sidebar, charts, and backend/API extension require explicit approval each |
...
| BX-I6C complete = BX-I6D/B4 implement approval | **BX-I6C** was **`/courses`** + **`/courses/:id`** visual presentation only; AppShell/global motion (**BX-I6D**), sidebar, chart UI/APIs, dashboard changes, and **B4** need separate gates |
| BX-I6B complete = BX-I6D/B4 implement approval | **BX-I6B** was **`/dashboard`** visual presentation only; broader visual rollout beyond dashboard/courses still needs separate gates |
