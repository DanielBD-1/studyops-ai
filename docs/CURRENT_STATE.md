...
**Last updated:** 2026-06-02 (Phase **B4-A** — tasks page body polish documentation housekeeping; prior **BX-I6D**)
...
**Not live:** chart UI, sidebar shell, course accents on material detail, **B4-B** flashcards page body polish, Trello/admin/focus/shared-state page body polish, remaining **B4** global styling rollout beyond **B4-A** — require separate planning and explicit approval.

**Branch (as of B4-A docs):** post-**B4-A** (commit **`4ae80ee`**)
...
| **B4** | **Partial** | **B4-A** **`/tasks`** page body presentation **complete** (commit **`4ae80ee`**); **B4-B** flashcards page body polish, Trello/admin/focus/shared-state polish, and remaining global styling rollout **not started** — each requires separate planning and explicit approval. |
| **BX-I6** (umbrella) | **Partial** | **BX-I6B**, **BX-I6C**, **BX-I6D**, and **B4-A** (tasks page body) presentation **complete**; sidebar shell, chart UI, chart APIs, flashcards/Trello/admin/focus page body polish, and backend/API extension **not started** — separate gates each. |
...
- **B4-B** — flashcards page body polish (requires separate planning and explicit approval; **B4-A** tasks **`/tasks`** body polish is **complete** — commit **`4ae80ee`**)
- **B4** (remaining) — Trello/admin/focus/shared-state page body polish and remaining global styling rollout beyond **B4-A** (requires separate planning and explicit approval each)
...
| **B4-B / remaining B4 / remaining BX-I6** | **Not started** — **B4-B** flashcards page body polish, Trello/admin/focus/shared-state polish, sidebar, chart UI/APIs, and backend/API extension each require separate planning and explicit **`approved — implement Phase X`** |

**Human next step (typical):** Optional authenticated visual QA for **BX-I2**, **BX-I3**, **BX-I4**, **BX-I5**, and **B4-A** when a valid local test account exists → plan **B4-B**, remaining **B4** / **BX-I6** work (sidebar, chart UI/APIs, flashcards/Trello/admin/focus page body polish), or other surfaces separately with explicit implement approval. **Do not** start **B4-B**, chart libraries, sidebar shell, dashboard/course/material page changes, or backend/API extension without a separately approved phase. **B4-A** is **complete** — next implementation phase is **not automatic**.
...
| B4 already approved | **Partial** — **B4-A** tasks **`/tasks`** page body polish is **complete** (commit **`4ae80ee`**); **B4-B** flashcards and remaining **B4** page-body polish are **not** started; each sub-phase requires explicit approval |
| BX-I6D complete = B4 or page-body polish approved | **BX-I6D** was global shell chrome (**`layout.css`** only); **B4-A** tasks body polish is **complete** separately; **B4-B**, flashcards/Trello/admin/focus polish, sidebar, charts, and backend/API extension need separate gates |
| B4-A complete = B4-B or other page-body polish approved | **B4-A** was **`/tasks`** page body presentation only — three approved files; **B4-B**, Trello/admin/focus polish, sidebar, charts, and backend/API extension need separate gates |
...
| BX-I6C complete = B4 or page-body polish approved | **BX-I6C** was **`/courses`** + **`/courses/:id`** visual presentation only; **B4-A** tasks body polish is **complete** separately; **B4-B**, remaining page-body polish, sidebar, and chart UI/APIs need separate gates |
| BX-I6D complete = B4 or page-body polish approved | **BX-I6D** was global shell chrome (**`layout.css`** only) — **no** route fade, page transitions, or auth changes; **B4-A** tasks body polish is **complete** separately; **B4-B** and other per-route body polish need separate gates |
