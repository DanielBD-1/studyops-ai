...
**Last updated:** 2026-06-02 (Phase **BX-I6B** — dashboard visual upgrade documentation housekeeping; prior **DOCS-WEB-ONLY**)
...
| **BX-I6C** / **BX-I6D** | **Not started** | Further visual rollout (e.g. courses/course-detail alignment, AppShell/global motion) — **not automatic** after BX-I6B; requires separate planning and explicit approval. |
| **B4** | **Not started** | Global styling rollout beyond BX-I2 token foundation — requires explicit **`approved — implement Phase B4`**. |
| **BX-I6** (umbrella) | **Partial** | **BX-I6B** dashboard presentation **complete**; sidebar shell, chart UI, chart APIs, and backend/API extension **not started** — separate gates each. |
...
| **Presentation** | **8C-3D**, **12A-1**, **B1**–**B3**, **BX-I2** (dark glass tokens, shell/cockpit polish, cards/badges), **BX-I4** (deterministic course accents on list/detail/dashboard), **BX-I5** (material detail cockpit visual polish), **BX-I6B** (dashboard command-center visual upgrade) — detail in **`IMPLEMENTATION_STATUS`** § UI polish |
...
- **BX-I6C** / **BX-I6D** — courses/course-detail visual alignment, AppShell/global motion, broader visual rollout (requires separate planning and explicit approval)
...
| **BX-I6C / BX-I6D / B4** | **Not started** — **not automatic** after BX-I6B; each requires separate planning and explicit **`approved — implement Phase X`** |

**Human next step (typical):** Optional authenticated visual QA for **BX-I2**, **BX-I3**, **BX-I4**, and **BX-I5** when a valid local test account exists → plan **BX-I6C**, **BX-I6D**, remaining **BX-I6** work (sidebar, chart UI/APIs), or **B4** separately with explicit implement approval. **Do not** start courses/course-detail visual alignment, AppShell/global motion, chart libraries, sidebar shell, or backend/API extension without a separately approved phase. Next implementation phase is **not automatic**.
...
| B4 or BX-I6C/BX-I6D already approved | **Not started** — **BX-I6B** dashboard presentation is complete; courses/course-detail alignment, AppShell/global motion, sidebar, charts, and backend/API extension require explicit approval each |
...
| BX-I6B complete = BX-I6C/BX-I6D/B4 implement approval | **BX-I6B** was **`/dashboard`** visual presentation only; broader visual rollout, sidebar, chart UI/APIs, and **B4** need separate gates |
