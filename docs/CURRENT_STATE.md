...
**Last updated:** 2026-06-02 (Phase **B4-C** — Trello page body polish documentation housekeeping; prior **B4-B**)
...
**Not live:** chart UI, sidebar shell, course accents on material detail, admin/focus/shared-state page body polish, remaining **B4** global styling rollout beyond **B4-A** + **B4-B** + **B4-C** — require separate planning and explicit approval.

**Branch (as of B4-C docs):** post-**B4-C** (commit **`cf50729`**)
...
| **B4** | **Partial** | **B4-A** **`/tasks`**, **B4-B** **`/flashcards`**, and **B4-C** **`/trello`** page body presentation **complete** (commits **`4ae80ee`**, **`f91415d`**, **`cf50729`**); admin/focus/shared-state polish and remaining global styling rollout **not started** — each requires separate planning and explicit approval. |
| **BX-I6** (umbrella) | **Partial** | **BX-I6B**, **BX-I6C**, **BX-I6D**, **B4-A**, **B4-B**, and **B4-C** presentation **complete**; sidebar shell, chart UI, chart APIs, admin/focus/shared-state page body polish, and backend/API extension **not started** — separate gates each. |
...
- **B4** (remaining) — admin/focus/shared-state page body polish and remaining global styling rollout beyond **B4-A** + **B4-B** + **B4-C** (requires separate planning and explicit approval each; **B4-A** **`/tasks`**, **B4-B** **`/flashcards`**, **B4-C** **`/trello`** body polish are **complete** — commits **`4ae80ee`**, **`f91415d`**, **`cf50729`**)
- **BX-I6** (remaining) — sidebar shell, chart UI, chart APIs, admin/focus/shared-state page body polish, backend/API extension **in code** (requires separate planning and explicit approval each)
...
| **Remaining B4 / remaining BX-I6** | **Not started** — admin page body polish, focus page polish, shared empty/loading/error state polish, sidebar, chart UI/APIs, and backend/API extension each require separate planning and explicit **`approved — implement Phase X`** |

**Human next step (typical):** Optional authenticated visual QA for **BX-I2**, **BX-I3**, **BX-I4**, **BX-I5**, **B4-A**, **B4-B**, and **B4-C** when a valid local test account exists → plan remaining **B4** / **BX-I6** work (admin/focus/shared-state polish, sidebar, chart UI/APIs), or other surfaces separately with explicit implement approval. **Do not** start admin/focus/shared-state polish, chart libraries, sidebar shell, dashboard/course/material page changes, or backend/API extension without a separately approved phase. **B4-C** is **complete** — next implementation phase is **not automatic**.
...
| B4 already approved | **Partial** — **B4-A** **`/tasks`**, **B4-B** **`/flashcards`**, and **B4-C** **`/trello`** page body polish are **complete** (commits **`4ae80ee`**, **`f91415d`**, **`cf50729`**); admin/focus/shared-state and remaining **B4** page-body polish are **not** started; each sub-phase requires explicit approval |
| BX-I6D complete = B4 or page-body polish approved | **BX-I6D** was global shell chrome (**`layout.css`** only); **B4-A**, **B4-B**, and **B4-C** are **complete** separately; admin/focus/shared-state polish, sidebar, charts, and backend/API extension need separate gates |
| B4-A complete = B4-B or other page-body polish approved | **B4-A** was **`/tasks`** page body presentation only — three approved files; **B4-B** and **B4-C** are **complete** separately; admin/focus polish, sidebar, charts, and backend/API extension need separate gates |
| B4-B complete = B4-C or other page-body polish approved | **B4-B** was **`/flashcards`** page body presentation only — three approved files; **B4-C** is **complete** separately; admin/focus/shared-state polish, sidebar, charts, and backend/API extension need separate gates |
| B4-C complete = admin/focus/shared-state polish approved | **B4-C** was **`/trello`** page body presentation only — seven approved files; admin/focus/shared-state polish, sidebar, charts, and backend/API extension need separate gates |
...
| BX-I6C complete = B4 or page-body polish approved | **BX-I6C** was **`/courses`** + **`/courses/:id`** visual presentation only; **B4-A**, **B4-B**, and **B4-C** are **complete** separately; admin/focus/shared-state polish, sidebar, and chart UI/APIs need separate gates |
| BX-I6D complete = B4 or page-body polish approved | **BX-I6D** was global shell chrome (**`layout.css`** only) — **no** route fade, page transitions, or auth changes; **B4-A**, **B4-B**, and **B4-C** are **complete** separately; admin/focus/shared-state polish needs separate gates |
