...
**Last updated:** 2026-06-02 (Phase **BX-I6D** — global shell chrome documentation housekeeping; prior **BX-I6C**)
...
**Not live:** chart UI, sidebar shell, course accents on material detail, **B4** global styling rollout, tasks/flashcards/Trello/admin **page body** polish beyond existing surfaces — require separate planning and explicit approval.

**Branch (as of BX-I6D docs):** post-**BX-I6D** (commit **`9252ba9`**)
...
| **BX-I6** (umbrella) | **Partial** | **BX-I6B**, **BX-I6C**, and **BX-I6D** presentation **complete**; sidebar shell, chart UI, chart APIs, tasks/flashcards/Trello/admin page body polish, and backend/API extension **not started** — separate gates each. |
...
- **B4** — global visual system rollout beyond BX-I2 token foundation (requires explicit **`approved — implement Phase B4`**)
- **BX-I6** (remaining) — sidebar shell, chart UI, chart APIs, tasks/flashcards/Trello/admin page body polish, backend/API extension **in code** (requires separate planning and explicit approval each)
...
| **B4 / remaining BX-I6** | **Not started** — **B4**, sidebar, chart UI/APIs, tasks/flashcards/Trello/admin page body polish, and backend/API extension each require separate planning and explicit **`approved — implement Phase X`** |

**Human next step (typical):** Optional authenticated visual QA for **BX-I2**, **BX-I3**, **BX-I4**, and **BX-I5** when a valid local test account exists → plan **B4**, remaining **BX-I6** work (sidebar, chart UI/APIs, page body polish), or other surfaces separately with explicit implement approval. **Do not** start **B4**, chart libraries, sidebar shell, dashboard/course/material page changes, or backend/API extension without a separately approved phase. **BX-I6D** is **complete** — next implementation phase is **not automatic**.
...
| B4 already approved | **Not started** — **B4** global styling rollout is **not** started; requires explicit **`approved — implement Phase B4`** |
| BX-I6D complete = B4 or page-body polish approved | **BX-I6D** was global shell chrome (**`layout.css`** only); **B4**, tasks/flashcards/Trello/admin page body polish, sidebar, charts, and backend/API extension need separate gates |
...
| BX-I6C complete = B4 or page-body polish approved | **BX-I6C** was **`/courses`** + **`/courses/:id`** visual presentation only; **B4**, page-body polish, sidebar, and chart UI/APIs need separate gates |
| BX-I6D complete = B4 or page-body polish approved | **BX-I6D** was global shell chrome (**`layout.css`** only) — **no** route fade, page transitions, or auth changes; **B4** and per-route body polish need separate gates |
